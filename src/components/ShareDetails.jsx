            ...
            <div className={`${show ? 'grid' : 'hidden'} px-[20px] content-center absolute top-[110%] z-[999] border border-gray-300 right-0 bg-white rounded-md w-[400px] h-[100px]`}>
                <div className='w-full h-[40px] grid grid-cols-[1fr_auto] gap-[10px]'>
                    ...
                    <div className='grid place-content-center'>
                        <button onClick={copyToClipboard} className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-indigo-100 border border-indigo-500 rounded-lg shadow-sm cursor-pointer hover:text-white bg-gradient-to-br from-purple-500 via-indigo-500 to-indigo-500">
