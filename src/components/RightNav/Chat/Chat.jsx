...
export default function Chat(){
    ...
    return(
        <div className="w-[400px] grid grid-rows-[auto_1fr] h-full mt-[10px] mr-[10px] border rounded-md bg-gray-200 dark:bg-gray-700 dark:border-gray-600 border-gray-400">
