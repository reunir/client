...
import {setRoomId} from '../utils/getRoomId'
export default function Meet() {
  ...
  const setRightNavHelper = (what) => {
    if (what === rightNav) setRightNav(0);
    else setRightNav(what);
  };
  const {
    error,
    videoTrack,
      ...
      <div className="static grid grid-flow-col pr-[10px] lg:pr-0 lg:grid-cols-[4fr_1fr] bottom-0 left-0 w-full lg:h-[100px] h-[80px] bg-[#f0f0f0] dark:bg-gray-800">
        ...
        <div className="grid w-[80%] h-[50%] grid-cols-[1fr_1.5fr] bg-[#e1e1e1] dark:bg-gray-700 place-self-center rounded-md">
          <div
            ...
            className={`cursor-pointer rounded-md grid grid-flow-col place-content-center gap-[5px] ${
              rightNav === 1
                ? "text-white bg-green-500 scale-[1.15] hover:bg-green-600"
                : "dark:hover:bg-gray-600 hover:bg-[#cacaca] dark:text-[#f0f0f0] text-gray-800"
            }`}
          >
            <div>
          ...
          <div
            ...
            className={`cursor-pointer rounded-md grid grid-flow-col place-content-center gap-[5px] ${
              rightNav === 2
                ? "text-white bg-red-700 scale-[1.15] hover:bg-red-800"
                : "dark:hover:bg-gray-600 hover:bg-[#cacaca] dark:text-[#f0f0f0] text-gray-800"
            }`}
          >
            <div>
