...
const generateAndReturnAvatar = (stripe,seed,backgroundColor) => {
    axiosExternal.get(`https://avatars.dicebear.com/api/${stripe}/${seed}.svg?background=%23${backgroundColor}`).then((avatar) => {
        return String(avatar.data);
    })
}
